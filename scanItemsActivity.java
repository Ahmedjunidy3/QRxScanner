...
public class scanItemsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timer.schedule(new TimerTask() {
            @Override
            public void run() {
                startActivity(new Intent(scanItemsActivity.this,FingerPrintActivity.class));
                finish();
            }
        }, 120000);
    }
    ...
    public void firebasesearch(String searchtext){
                        ...
                        firebaseSearchQuery )
        {
            ...
            protected void populateViewHolder(UsersViewHolder viewHolder, Items model,int position){
                ...
                viewHolder.setDetails(getApplicationContext(),model.getItembarcode(),model.getItemnumber(),model.getItemname());
            }
        };
    ...
    public void setDetails(Context ctx, String itembarcode, String itemname, String itemnomb){
                ...
                TextView item_nomb = (TextView) mView.findViewById(R.id.viewitemnumb);

                item_barcode.setText(itembarcode);
                item_name.setText(itemname);
                item_nomb.setText(itemnomb);
    }
