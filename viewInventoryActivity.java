    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mdatabaseReference = FirebaseDatabase.getInstance().getReference("Users").child(resultemail).child("Items");
         ...
         timer.schedule(new TimerTask() {
             @Override
             public void run() {
                 startActivity(new Intent(viewInventoryActivity.this,FingerPrintActivity.class));
                 finish();
             }
         }, 120000);
    ...
    mdatabaseReference.addValueEventListener(new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
            ...
            for(DataSnapshot ds : dataSnapshot.getChildren()){
                ...
                Object price = map.get("itemnumber");
    ...
    protected  void  onStart() {
                        ...
                        mdatabaseReference )
        {
            ...
            protected void populateViewHolder(scanItemsActivity.UsersViewHolder viewHolder, Items model, int position){
                ...
                viewHolder.setDetails(getApplicationContext(),model.getItembarcode(),model.getItemname(),model.getItemnumber());
            }
        };
